...
declare namespace ExtendableExpander {
    ...
    type EventListener<T extends ExtendableExpander> = (this: T, event: Event) => void;
}
...
declare class PropertyExpander<T> extends ExtendableExpander {
    ...
    toType(): "object" | "symbol" | "function" | "boolean" | "number" | "null" | "regexp" | "iterable" | "string";
}
...
declare class PageModule extends ExtendableModule {
    static readonly version = "2019-11-05";
